...
<?php 
     if (!$_GET) {
          header('location:portafoliopeliculas.php?pagina=1');
        }
     if ($_GET['pagina']>$paginas || $_GET['pagina']<=0) {
       ...
       $sql_articulos='SELECT * FROM peliculas LIMIT :iniciar,:articulos';
...
<head>
  ...
  <script type="text/javascript" src="../js/funcionp.js"></script>
  
        </header>
             
          
      <div class="container">
      <h1 align="center"><span class="buscar1">portafolio peliculas</span></h1></br>
      ...
      ?>
            <!--visualizacion de la informacion en el protafolio-->
              <th style="border-color:red;background-color: #C7E5B4;"><span><?php echo $articulo['titulo']?></span>
                 <h5>GENERO:</h5><span class="spn"><?php echo $articulo['genero']?></span>
                    <h5>AÑO:</h5><span class="spn"><?php echo $articulo['year']?></span>
             
              </th>
       	  	          <th  style="border-color:red;background-color: #E4D2D2;"><img src="../imgp/<?php echo $articulo['imagen']?>" class="img-rounder" id="img"  width="190" height="200"><br>
                        <button type="button" class="btn btn-success" data-toggle="modal" 
                           data-target="#exampleModal"
                            onclick="enviar(<?php echo $articulo['idpelicula']?>)"><i class="fas fa-sign-in-alt"></i> Mas</button>
              </th>
...
-->
    <li class="page-item<?php echo $_GET['pagina']<=1 ? 'disabled' : '' ?>">
      <!-- pasa de paginas-->
      <a class="page-link" href="portafoliopeliculas.php?pagina=<?php echo $_GET['pagina']-1?>">
          ...
          <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
    	   <a class="page-link" 
   	   href="portafoliopeliculas.php?pagina=<?php echo $i+1;?>"><?php echo $i+1;?></a>
   </li>
 <?php endfor ?>
   <li class="page-item
...
<script>
      ...
      xmlhttp.open("GET","detallepeli.php?cod="+c,true);
      xmlhttp.send();
   }
 </script>
